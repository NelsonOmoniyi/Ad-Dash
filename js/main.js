...
function checklogin(formurl,formurlconvert){		
		...
		//$('#error_label_login').css({background-image: "url(../img/progress_bar.gif)"});
...
{
	$("#state_div").html('<img src="img/loading.gif" alt=""/>&nbsp;&nbsp;Loading states please wait . . .');
...
function importExcel(){
	...
	$.blockUI({ message:'<img src="img/loading.gif" alt=""/><br />Extracting File to Database . . .'});
	$.ajax({ 
			   type: "POST", 
			   url: "utilities.php", 
