  ...
  <style>
   ...
   <div class="card">
    <div class="card-header">
        ...
        <h6 class="card-subtitle text-muted">The report contains Admin that have been setup in the system.</h6>
    </div>
    <div class="card-body">
     <div class="row">
       
         <div class="col-sm-2">
             <a class="btn btn-warning" onclick="getModal('setup/user_edit.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create Admin <br>& <br> Rider</a>
         </div>
