...
$userQL = "SELECT username,firstname,lastname FROM userdata WHERE role_id = '003'";
$users = $dbobject->db_query($userQL);
       ...
       <div class="row" style="<?php echo ($operation == "edit")?"display:none":""; ?>">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="email" name="username" <?php echo ($operation == "edit")?"disabled":""; ?> class="form-control" value="<?php echo $username; ?>" placeholder="">
